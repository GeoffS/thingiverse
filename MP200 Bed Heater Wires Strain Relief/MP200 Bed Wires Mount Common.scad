...
// Used in mountBody() and modules that interface with it.
...
module torus2b(radius, translation)
{
  echo("2a radius, translation", radius, translation);
  rotate_extrude(convexity = 4)
  translate([translation, 0, 0]) circle(r = radius, $fn=20);
}

module torus3b(outsideDiameter, circleDiameter)
{
  circleRadius = circleDiameter/2;
  torus2b(circleRadius, outsideDiameter/2-circleRadius);
}
